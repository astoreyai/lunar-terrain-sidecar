...
**Test suite**: 347 tests across 17 files. The two required CI jobs cover all
...
full 347-test matrix; it does not accept a missing-data skip as success.
...
docs/       decisions/
tests/      347 tests across 17 files
```
